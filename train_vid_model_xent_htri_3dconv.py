...
import data_manager
from dataset_loader_3d import ImageDataset, VideoDataset
...
parser.add_argument('--test-batch', default=1, type=int, help="test batch size (number of tracklets)")
...
parser.add_argument('--pretrained-model', type=str, default='/home/jiyang/Workspace/Works/video-person-reid/3dconv-person-reid/pretrained_models/resnet-50-kinetics.pth', metavar='PATH')
...
def main():
    ...
    #for key in checkpoint['state_dict']: print(key)
    #for key in model.state_dict(prefix='module'): print(key)
